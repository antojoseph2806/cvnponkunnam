    ...
    <header className="w-full fixed top-0 left-0 z-50">
      ...
      <div className="bg-primary text-primary-foreground text-sm py-2 px-4 md:px-8 lg:px-16 flex justify-between items-center">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3 ml-2">
            ...
            <a href="#" aria-label="WhatsApp" className="hover:text-highlight-light transition-colors">
      ...
      <nav className="bg-card/95 backdrop-blur-md shadow-sm px-4 md:px-8 lg:px-16 flex items-center justify-between h-20">
        <a href="#home" className="flex items-center gap-3">
          <img src={logo} alt="AKM Sree Rudra Logo" className="h-14 w-14 rounded-full object-cover" />
          <span className="font-heading text-xl font-bold text-primary">AKM Sree Rudra</span>
        </a>
