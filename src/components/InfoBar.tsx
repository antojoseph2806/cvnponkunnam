...
const InfoBar = () => (
  <section className="bg-section-dark text-primary-foreground py-6 px-4 md:px-8">
    <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
      <div className="motion-reveal motion-fade-up motion-delay-1 flex flex-col items-center gap-2">
        <MapPin className="w-8 h-8 text-highlight-light" />
        <p className="font-semibold">Sree Rudra CVN Kalari</p>
        <p className="text-sm text-primary-foreground/70">Lakkattoor</p>
      </div>
      <div className="motion-reveal motion-fade-up motion-delay-2 flex flex-col items-center gap-2">
      ...
      <div className="motion-reveal motion-fade-up motion-delay-3 flex flex-col items-center gap-2">
